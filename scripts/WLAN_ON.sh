...
sshpass -p $ONTPASS ssh ONTUSER@192.168.1.1 cfgcli -s InternetGatewayDevice.LANDevice.1.WLANConfiguration.1.RadioEnabled true
sshpass -p $ONTPASS ssh ONTUSER@192.168.1.1 cfgcli -s  InternetGatewayDevice.LANDevice.1.WLANConfiguration.5.RadioEnabled true
